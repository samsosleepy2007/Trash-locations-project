...
**สถานะ:** โค้ดพร้อมตั้งค่า แต่ `activity-config.js` ปิดการเข้าสู่ระบบไว้จนกว่าจะเชื่อมฐานข้อมูล บัญชีแอดมิน และผู้ให้บริการอีเมลจริง ดูขั้นตอนเปิดใช้งานและข้อจำกัดใน [supabase/SETUP.md](supabase/SETUP.md)
